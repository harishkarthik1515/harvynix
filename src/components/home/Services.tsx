...
const services = [
  {
    ...
    icon: Briefcase,
    image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=800', // Visible tech image for Portfolio Websites
  },
  {
  ...
  },
  {
    ...
    icon: Layout,
    image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=800', // Visible tech image for Static Websites
  },
  {
    title: 'Business Websites',
    description: 'Professional business websites with customizable content and modern features.',
    icon: FileCode,
    image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=800', // Visible tech image for Business Websites
  },
];
